...
$sql_query3 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 3 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 3 Order by checkoutnum DESC LIMIT 3";
...
$sql_query4 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 4 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 4 Order by checkoutnum DESC LIMIT 3";
...
$sql_query5 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 5 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 5 Order by checkoutnum DESC LIMIT 3";
...
$sql_query6 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 6 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 6 Order by checkoutnum DESC LIMIT 3";
...
$sql_query7 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 7 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 7 Order by checkoutnum DESC LIMIT 3";
...
$sql_query8 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 8 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 8 Order by checkoutnum DESC LIMIT 3";
...
$sql_query9 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 9 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 9 Order by checkoutnum DESC LIMIT 3";
...
$sql_query10 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 10 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 10 Order by checkoutnum DESC LIMIT 3";
...
$sql_query11 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 11 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 11 Order by checkoutnum DESC LIMIT 3";
...
$sql_query12 = "Select Username, checkoutnum From (Select Month(IssueDate) AS month, Username, Count(IssueID) AS checkoutnum From book AS B, issue AS I
	Where B.ISBN = I.ISBN AND Month(IssueDate) = 12 AND ExtenDate IS NOT NULL
	Group by month, Username) AS V Where month = 12 Order by checkoutnum DESC LIMIT 3";
  ...
  <div class="parent">
    <div class="child-centralise" style="width: 100%;">
      <div class="justForNow">
        <form action="AdminSummary.php" method="post" style="width:100%">
